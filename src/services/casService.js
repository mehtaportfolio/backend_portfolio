...
let standardFontDataUrl = pathToFileURL(join(__dirname, '..', '..', 'node_modules', 'pdfjs-dist', 'standard_fonts')).toString();
...
// ================= PDF TEXT EXTRACTION =================
export async function extractTextFromPDF(buffer, accountName, customPassword = null) {
  const loadingTask = pdfjsLib.getDocument({
    data: new Uint8Array(buffer),
    password: customPassword || getPAN(accountName),
